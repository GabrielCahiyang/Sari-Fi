...
const HERO_IMAGE =
  "https://images.unsplash.com/photo-1759860002165-f059bfcee759?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxzYXJpLXNhcmklMjBzdG9yZSUyMHBoaWxpcHBpbmVzJTIwZ3JvY2VyeSUyMG1hcmtldHxlbnwxfHx8fDE3ODgzNzI1NTF8MA&ixlib=rb-4.1.0&q=80&w=1080";
const STORE_IMAGE =
  "https://images.unsplash.com/photo-1759774289306-36f0cdb59bc1?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwyfHxzYXJpLXNhcmklMjBzdG9yZSUyMHBoaWxpcHBpbmVzJTIwZ3JvY2VyeSUyMG1hcmtldHxlbnwxfHx8fDE3ODgzNzI1NTF8MA&ixlib=rb-4.1.0&q=80&w=1080";
const OWNER_IMAGE =
  "https://images.unsplash.com/photo-1687422808311-a776f467a468?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwzfHxzbWFsbCUyMGJ1c2luZXNzJTIwd29tYW4lMjBlbnRyZXByZW5ldXIlMjBzdG9yZSUyMG93bmVyfGVufDF8fHx8MTc4ODM3MjU2MHww&ixlib=rb-4.1.0&q=80&w=1080";
...
const STEPS = [
  {
    ...
    description:
      "Visit any Sari-Fi branch. Our staff records your personal and store information during your application.",
  },
  {
    number: "02",
    title: "Get Approved",
    description:
      "Our team reviews your application. Approved applicants receive a personal Sari-Fi account with a starting credit line.",
  },
  {
    number: "03",
    title: "Shop & Finance",
    description:
      "Log in, browse wholesale inventory, and choose how to pay — full, financed, or split.",
  },
];
  ...
  return [
    {
      ...
      description:
        "As you repay, your available credit restores automatically. One approval, ongoing access.",
    ...
    },
    {
      ...
      description:
        "Pay in full, use Sari-Fi financing, or split your payment between credit and cash or GCash.",
      color: "bg-white border border-[#E4E8E6]",
      textMuted: "text-[#65727A]",
      iconColor: "text-[#1E7D3B]",
    },
    ...
    },
    {
      ...
      title: "GCash Ready",
      description:
        "Pay installments or orders via GCash — instant confirmation, no queuing at the counter.",
      color: "bg-white border border-[#E4E8E6]",
      textMuted: "text-[#65727A]",
      iconColor: "text-[#1E7D3B]",
    },
...
export function HomePage() {
  ...
  const benefits = useMemo(
    () => getBenefits(settings, state.products.length),
    [settings, state.products.length],
  );
  ...
  return (
    <div className="min-h-full bg-[#F7F8F6] font-sans overflow-x-hidden selection:bg-[#1E7D3B] selection:text-white">
      ...
      >
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8 text-sm font-600 text-[#65727A]">
            <a
              href="#how-it-works"
              className="hover:text-[#0D2B45] hover:-translate-y-0.5 transition-all"
            >
              How It Works
            </a>
            <a
      ...
      <section className="relative overflow-hidden min-h-[540px] md:min-h-[620px] flex items-center">
        ...
        <div className="relative max-w-6xl mx-auto px-6 py-24 md:py-36 w-full">
          <div className="max-w-2xl">
            ...
            >
              Sari-Fi helps sari-sari store owners access the inventory they
              need — without relying on high-interest informal lenders. Repay
              weekly, grow your limit, keep your shelves full.
            </motion.p>
          ...
          <div className="max-w-6xl mx-auto px-6 py-5">
            ...
            >
              {[
                ...
                {
                  value: `${state.products.length || 30}+`,
                  label: "Product Lines",
                },
                ...
                >
                  ...
                  <div className="text-white/70 text-xs font-600 mt-0.5">
                    {stat.label}
                  </div>
                </motion.div>
              ))}
              ...
              return (
                ...
                >
                  ...
                  >
                    ...
                    <h3 className="font-800 text-lg text-[#10212B] mb-2">
                      {step.title}
                    </h3>
      ...
      <section
        id="revolving"
        className="py-24 px-6 bg-white border-y border-[#E4E8E6] relative overflow-hidden"
      >
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="sm:absolute sm:-bottom-6 sm:-right-6 mt-4 sm:mt-0 bg-[#1E7D3B] text-white rounded-3xl p-4 sm:p-5 shadow-2xl w-full sm:w-auto sm:min-w-[240px] border border-white/20">
              ...
              <div className="text-white font-900 text-2xl sm:text-3xl tnum">
                {peso(LIMIT - used)}
              </div>
          ...
          >
            <h2 className="text-3xl sm:text-4xl font-900 text-[#0D2B45] leading-tight mb-4">
              Credit That Restores
              <br />
              As You Repay
            </h2>
            <p className="text-[#65727A] text-sm leading-relaxed mb-8">
              Unlike a one-time loan, Sari-Fi gives you a revolving credit line.
              Every peso you repay is immediately returned to your available
              credit — so you can restock again without waiting for a new
              approval.
            </p>
            ...
            <div className="space-y-4">
              {[
                ...
                >
                  ...
                  <div>
                    <div className="text-sm font-700 text-[#10212B]">
                      {item.label}
                    </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-[#65727A] mt-3 text-sm leading-relaxed max-w-sm">
              Everything a sari-sari store owner needs to keep shelves stocked
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <p className="text-sm text-[#65727A] leading-relaxed mb-7">
              Sari-Fi is exclusively for sari-sari store owners. Applications
              are processed in person at any Sari-Fi branch — there is no online
              registration.
            </p>
            ...
            <div className="bg-amber-50 border border-amber-200 rounded-xl p-4 text-sm text-amber-800">
              <span className="font-700">Note:</span> Sari-Fi does not offer
              online registration. Visit a branch to start your application.
            </div>
          </motion.div>
          ...
          >
            ...
            >
              <div className="text-xs text-[#65727A] mb-0.5">
                Starting limit
              </div>
              <div className="text-[#0D2B45] font-800 text-lg sm:text-xl">
                {peso(LIMIT)}
              </div>
              <div className="text-xs text-[#7DBE4C] font-600 mt-1">
                ↑ Grows +{peso(LIMIT_INC)} each cycle
              </div>
            </motion.div>
          </motion.div>
        </div>
      ...
      <section
        id="calculator"
        className="py-24 px-6 bg-[#0D2B45] text-white relative overflow-hidden"
      >
        <div className="max-w-6xl mx-auto relative">
          ...
          >
            ...
            <p className="text-white/60 mt-3 text-sm leading-relaxed">
              A simple, transparent calculation with no hidden fees. Adjust the
              amount and plan to see your schedule.
            </p>
          </motion.div>
          ...
          <div className="max-w-3xl space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {[
                {
                  label: "Principal",
                  value: peso(principal),
                  sub: "Amount borrowed",
                },
                {
                  label: `Finance Charge (${CHARGE_PCT}%)`,
                  value: peso(charge),
                  sub: "Applied to principal",
                },
                {
                  label: "Total Repayable",
                  value: peso(total),
                  sub: `${weeks} weekly payments × ${peso(perWeek)}`,
                },
              ].map((card) => (
                <motion.div
                  key={card.label}
                ...
                >
                  <div className="text-white/50 text-xs font-600 mb-2">
                    {card.label}
                  </div>
                  <div className="text-white font-800 text-2xl mb-1 tnum">
                    {card.value}
                  </div>
            ...
            <div className="bg-white/5 border border-white/10 rounded-2xl p-5">
              ...
              <div
                className={`grid grid-cols-4 gap-2 ${weeks > 4 ? "md:grid-cols-8" : "md:grid-cols-4"}`}
              >
                {Array.from({ length: weeks }, (_, i) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <div
                        className={`text-xs font-700 tnum ${isPaid ? "text-white" : "text-white/70"}`}
                      >
                        {peso(perWeek)}
                      </div>
                      <div
                        className={`text-[9px] mt-0.5 ${isPaid ? "text-white/70" : "text-transparent"}`}
                      >
                        Paid
                      </div>
                    </motion.button>
      ...
      <footer className="bg-[#0A2138] border-t border-white/[0.06] text-white">
        <div className="max-w-6xl mx-auto px-6 py-12">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-10">
            <div className="md:col-span-2 flex flex-col gap-3">
              ...
              <p className="text-sm text-white/50 leading-relaxed max-w-xs">
                Financing Your Stock, Growing Your Business. Dedicated
                micro-enterprise inventory funding for Philippine sari-sari
                store owners.
              </p>
            </div>
            <div className="flex flex-col gap-3 text-sm">
              <span className="text-xs font-700 text-white/30 uppercase tracking-widest">
                Platform
              </span>
              <button
                onClick={() => navigate("login")}
            ...
            <div className="flex flex-col gap-3 text-sm">
              ...
              <a
                href="mailto:support@sari-fi.ph"
          ...
          <div className="border-t border-white/[0.07] pt-6 flex flex-col md:flex-row items-center justify-between gap-3 text-xs text-white/30">
            <span>
              &copy; {new Date().getFullYear()} Sari-Fi. All rights reserved.
            </span>
            <div className="flex items-center gap-5">
              {["Privacy Policy", "Terms of Service", "BSP Disclosure"].map(
                (l) => (
                  <button
                    key={l}
