...
export function CustomerLoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    if (!ok) {
      setError('Invalid email or password. Please verify your credentials or contact store staff.');
  ...
  return (
    <div className="min-h-screen bg-[#F7F8F6] flex flex-col justify-center items-center p-4 sm:p-6 font-sans relative overflow-hidden">
      ...
      <div className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[520px] h-[520px] bg-[#1E7D3B]/5 rounded-full blur-3xl pointer-events-none" />
      ...
      >
        ...
        <div className="absolute top-0 left-0 right-0 h-1.5 bg-gradient-to-r from-[#1E7D3B] via-[#7DBE4C] to-[#1E7D3B]" />

        {/* Brand Header */}
        <div className="text-center mb-6 pt-2">
          <div className="inline-flex items-center justify-center p-3 rounded-2xl bg-[#1E7D3B]/10 border border-[#1E7D3B]/20 mb-3 shadow-xs">
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          <div>
            ...
            <input
              ...
              placeholder="e.g. nena@sarifi.ph"
              className="w-full px-4 py-3 bg-[#F7F8F6] border border-[#E4E8E6] rounded-xl text-sm text-[#10212B] placeholder-[#C5CBD0] focus:outline-none focus:ring-2 focus:ring-[#1E7D3B]/30 focus:border-[#1E7D3B] transition-all"
            />
          </div>
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                placeholder="••••••••"
                className="w-full px-4 py-3 bg-[#F7F8F6] border border-[#E4E8E6] rounded-xl text-sm text-[#10212B] placeholder-[#C5CBD0] focus:outline-none focus:ring-2 focus:ring-[#1E7D3B]/30 focus:border-[#1E7D3B] transition-all pr-11"
              />
              <button
                type="button"
